...
try {
  var options2 = {
    ...
    series: [
      {
        data: [
          30, 50, 60, 42, 48, 56, 29, 25, 46, 12, 58, 45, 89, 52, 41, 20, 13, 5,
          20, 15, 19, 45, 45, 86, 75, 66, 55, 46, 61, 19999,
        ],
      },
    ],
    xaxis: {
  ...
  new ApexCharts(document.querySelector("#sale-charts"), options2).render();
} catch (error) {}
...
try {
  ...
  var chart = new ApexCharts(
    document.querySelector("#top-product-chart"),
    options
  );
  chart.render();
} catch (error) {}
